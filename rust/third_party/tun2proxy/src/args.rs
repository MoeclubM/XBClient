...
pub struct Args {
    ...
    /// IPv6 address pool to be used by virtual DNS in CIDR notation.
    #[arg(long, value_name = "CIDR", default_value = "fdfe:dcba:9877::/64")]
    pub virtual_dns_pool_v6: IpCidr,
...
impl Default for Args {
    fn default() -> Self {
        ...
        Args {
            ...
            virtual_dns_pool_v6: IpCidr::from_str("fdfe:dcba:9877::/64").unwrap(),
            daemonize: false,
